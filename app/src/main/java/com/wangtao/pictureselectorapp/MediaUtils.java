...
public class MediaUtils {
    ...
    public MediaExtraBean getRingDuring(Context context, Uri mUri){
        Log.e("YM","文件路径:"+mUri);
        ...
        try {
            ParcelFileDescriptor parcelFileDescriptor =
                    context.getContentResolver().openFileDescriptor(mUri, "r");
...
//                            mUri, new Size(640, 480), null);
            ...
            try {
                ParcelFileDescriptor imageFd = context.getContentResolver().openFileDescriptor(uri, "w");
